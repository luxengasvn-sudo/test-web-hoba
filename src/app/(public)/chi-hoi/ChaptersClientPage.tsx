...
function formatChapters(chaptersData: any[]): Chapter[] {
...
export default function ChaptersClientPage({
  initialChapters = [],
  initialMembers = []
}: {
  initialChapters?: any[];
  ...
  const [chapterList, setChapterList] = useState<Chapter[]>(() => {
    if (initialChapters && initialChapters.length > 0) {
      return formatChapters(initialChapters);
    }
    return defaultChapters as Chapter[];
  });
